package com.walrex.module_mailing.config.kafka;
...
@Configuration
public class MailingKafkaCommonConfig {
    ...
    @Bean(name = "mailingModuleSchemaRegistryClient")
    public SchemaRegistryClient mailingModuleSchemaRegistryClient() {
        return new CachedSchemaRegistryClient(schemaRegistryUrl, 100);
    }

    @Bean(name = "mailingModuleSchemaRegistryConfig")
    public Map<String, Object> mailingModuleSchemaRegistryConfig() {
