package com.walrex.user.module_users.config.kafka.producer.config;
...
public class UserKafkaProducerConfig {
    ...
    public UserKafkaProducerConfig(@Qualifier("userModuleSchemaRegistryConfig") Map<String, Object> schemaRegistryConfig) {
        this.schemaRegistryConfig = schemaRegistryConfig;
    }

    @Bean(name = "userModuleProducerConfigs")
    public Map<String, Object> userModuleProducerConfigs(){
    ...
    @Bean(name = "userModuleProducerOptions")
    public SenderOptions<String, Object> userModuleProducerOptions() {
        return SenderOptions.create(userModuleProducerConfigs());
    }
}
