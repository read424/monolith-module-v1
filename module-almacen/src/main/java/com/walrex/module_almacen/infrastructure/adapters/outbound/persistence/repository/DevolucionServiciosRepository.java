...
public interface DevolucionServiciosRepository extends R2dbcRepository<DevolucionServiciosEntity, Long> {
     ...
     */
    Flux<DevolucionServiciosEntity> findByIdOrdenSalida(Integer idOrdenSalida);
    ...
    /**
     * Buscar devoluciones por empresa de transporte
     */
    Flux<DevolucionServiciosEntity> findByIdEmpresaTransp(Integer idEmpresaTransp);
