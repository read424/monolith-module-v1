...
public interface OrdenSalidaRepository extends ReactiveCrudRepository<OrdenSalidaEntity, Long> {
        ...
        Mono<OrdenSalidaEntity> agregarOrdenSalida(Integer id_motivo, Integer id_almacen, Integer id_usuario,
                        LocalDate fec_entrega, Integer entregado);
        ...
        Mono<Integer> asignarEntregado(Date fech_entrega, Integer idUsuarioEntrega, Integer idSupervisor,
                        Integer idUserDeclara, Integer id_ordensalida);
