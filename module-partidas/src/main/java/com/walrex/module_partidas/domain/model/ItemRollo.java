...
/**
 * Modelo de dominio para Item Rollo
 * Representa la información detallada de un rollo específico
 * 
...
public class ItemRollo {
    ...
    */
    ...
    /**
     * ID del ingreso de peso (id_detordeningresopeso - produccion)
    */
    ...
    /**
     * ID del rollo de ingreso (id_detordeningresopeso - crudo)
     */
